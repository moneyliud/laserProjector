...
GCC_PATH="E:/PROGRAM/GCC-ARM-NONE-EABI/BIN
ifdef GCC_PATH
...
#######################################
# link script
LDSCRIPT = STM32H743VGTx_FLASH.ld
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"E:/PROGRAM/OPENOCD/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"E:/PROGRAM/OPENOCD/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32h7x mass_erase 0; exit"
